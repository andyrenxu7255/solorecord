...
| [multi-platform-clients.md](multi-platform-clients.md) | Android、Windows、macOS、iOS、HarmonyOS 构建与发布 |
...
2. 配 `server/.env`。
3. 启动服务。
4. 上传 Android、Windows、macOS、iOS 或 HarmonyOS 终端发布包。
...
| [multi-platform-clients.md](multi-platform-clients.md) | Android, Windows, macOS, iOS, and HarmonyOS build and publishing |
...
For deployment, start with [human-ops/README.md](human-ops/README.md), configure `server/.env`, start the service, upload the required client packages, and run one real test meeting through recording, transcription, summary, sync, and export.
