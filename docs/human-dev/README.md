...
- 日期和截止时间短语只作为任务时间事实，不能被提升为发言人或负责人。规则分段会过滤“今天下午、周三前、月底前”等候选，避免污染人物列表。
...
- Date and deadline phrases are time facts only, not speakers or owners. Rule segmentation filters candidates such as "this afternoon", "before Wednesday", and "by month end" so they do not pollute the speaker list.
